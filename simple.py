...
class MQTTClient:
    ...
    def lock_msg_rec(self):
        self.lock = True
    
    def unlock_msg_rec(self):
        self.lock = False
    ...
    # """
    #     return state, msg -> (topic, msg_len)
    #     state:  0  -> not msg
    #             1  -> get REQ
    #             2  -> get topic
    #             -1 -> mqtt disconnect
    ...
    def topic_msg_get(self, msg_len):
        self.sock.setblocking(True)
